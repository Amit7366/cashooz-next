...
const Footer = () => {
  return (
     <footer className="bg-secondaryColor text-black py-10 px-6 md:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-2 gap-6 justify-between items-center">
          ...
          <div className="text-right">
            ...
            <ul className="space-y-2 text-sm flex flex-col">
              ...
              <Link href={"/termsncondition"}>Terms of Service</Link>
              <Link href={"/privecy-policy"}>Privacy</Link>
            </ul>
          </div>
        </div>
